  ...
  render() {
    return (
        <div className="bio">
            ...
            <blockquote className="main_quote">Perfection is achieved, not when there is nothing more to add, but when there is nothing left to take away.<br /><br /><span className="right">&mdash; Antoine de Saint-Exup&eacute;ry</span></blockquote>
        </div>
    )
  }
}
